...
const FilterButton = ({ name }: FilterButtonProps) => {
  ...
  return (
    <button
      className="text-md aspect-square w-full rounded-sm border-b-2 border-slate-300 dark:border-slate-200 bg-slate-500 dark:bg-slate-800 font-semibold capitalize text-slate-300 dark:text-slate-200 hover:bg-slate-600 dark:hover:bg-slate-700 active:bg-slate-500 md:text-2xl"
      onClick={() => {
